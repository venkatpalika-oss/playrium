...
(function () {
  function injectStyle() {
    ...
    var css = '.pr-continue{max-width:1200px;margin:0 auto;padding:1rem 1.5rem 3rem;font-family:var(--font-display,system-ui,sans-serif);color:var(--chalk,#f4f0e6);}'
      ...
      + '.pr-prevnext{display:flex;justify-content:space-between;gap:1rem;flex-wrap:wrap;margin-bottom:1.5rem;}'
  ...
  function render() {
    ...
    html += '<button type="button" class="pr-pill" id="pr-random-btn">\uD83C\uDFB2 Random Experience</button>';
